...
interface cartItemInterface {
	...
	onRemove: Function,
	onAddItem: Function,
	onMinusItem: Function,
}

const startImage = 'https://dodopizza.azureedge.net/static/Img/Products/Pizza/ru-RU/b750f576-4a83-48e6-a283-5a8efb68c35d.jpg'

export const CartItem = ({ id, name, image = startImage, type, size, totalPrice, totalCount, onRemove, onAddItem, onMinusItem }: cartItemInterface): JSX.Element => {
